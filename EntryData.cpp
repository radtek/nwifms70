...
int CEntryData::LoadTickets()
{
	...
	if(GetFXEntry())
	{
		Sql = "SELECT A.TICKET_NUM, A.TRADER_INI, TRADE_DATE, EXEC_TIME, TRANS_TYPE, DIR, VALUE_DATE, "
				"NOM_AMOUNT, STRIKE, OPT_EXPIRATION, OTC, OPT_TICK, OPT_SET_CODE, OPT_SET_CODE2, "
				"ASSET_PID, EURO_OPT, OPT_AUTO, COUNTERPARTY, CURRENCY, FXRATE, ASSET_CODE, "
				"ASSET_DESC, ASSET_CURRENCY, IPO, TRS, REPO_CP, TR_RATE, RATE_BASIS, MATURITY, NOTE, "
				"NOTE2, SW_BOOKING, SW_MATURITY, FLOAT_RATE, FLOAT_RATE_BASIS, FLOAT_MATURITY, WI, "
				"SWAP_TICKET, DELIVERY_DATE, MARGIN, MARGIN_CURRENCY, MARGIN_AMOUNT, FUNDED_SWAP, "
				"BINARY, AA_METHOD, AA_FREASON, BEST_EXECUTION, SHORT_SALE, CSPB_SHORT, ETRADE, PRICE, "
				"DOWN_PYMNT, BROKER_FEE, OTHER_FEE, SOFTDOLLAR, ASSIGN_CP, DV01, VAR, UNWIND_TICKET, "
				"CANCEL_TICKET, CORRECT_TICKET, ASSET_COUNTRY, ASSET_COMMON_CODE, ASSET_MSTC_CODE, "
				"ASSET_ISIN_CODE, ASSET_SEDOL_NUM, ASSET_CLASS, ASSET_IND_AREA, ASSET_CATEGORY, "
				"ASSET_BUCKET, SOURCE, ASSET_COUPON, ASSET_MATURITY, NULL \"CP_KEY\", A.ORDER_ID ";
		...
		Sql +=	"AND (A.ASSET_CLASS IN ('CURRENCY FWDS', 'CURRENCY OPTION') OR TRANS_TYPE = 'FOREX') ";
				...
				"DECODE(CURRENCY, 'USD', 1, TO_NUMBER(NULL)) \"FXRATE\", ASSET_CODE, ASSET, "
				"A.ASSET_CURRENCY, IPO, NULL \"TRS\", NULL \"REPO_CP\", RATE, NULL \"RATE_BASIS\", "
				...
				"AA_METHOD, NULL \"AA_FREASON\", NULL \"BEST_EXECUTION\", NULL \"SHORT_SALE\", "
				"NULL \"CSPB_SHORT\", ETRADE, PRICE, DECODE(A.DEAL_TYPE, 'TRS', 0, 100) \"DOWN_PYMNT\", "
				"TO_NUMBER(NULL) \"BROKER_FEE\", TO_NUMBER(NULL) \"OTHER_FEE\", TO_NUMBER(NULL) \"SOFTDOLLAR\", "
				"NULL \"ASSIGN_CP\", TO_NUMBER(NULL) \"DV01\", TO_NUMBER(NULL) \"VAR\", "
				"TO_NUMBER(REF_TICKET) \"UNWIND_TICKET\", TO_NUMBER(NULL) \"CANCEL_TICKET\", "
				"TO_NUMBER(NULL) \"CORRECT_TICKET\", ASS_COUNTRY, ASS_COMMON_CODE, ASS_MSTC_CODE, "
				"ASS_ISIN_CODE, ASS_SEDOL_NUM, ASSET_CLASS, ASS_IND_AREA, CATEGORY, BUCKET, SOURCE, "
	...
	{
		if(GetBlotter())
			Sql = "SELECT TICKET_NUM, A.TRADER_INI, TRADE_DATE, EXEC_TIME, TRANS_TYPE, DIR, VALUE_DATE, "
					"NOM_AMOUNT, STRIKE, OPT_EXPIRATION, OTC, OPT_TICK, OPT_SET_CODE, OPT_SET_CODE2, "
					"ASSET_PID, EURO_OPT, OPT_AUTO, COUNTERPARTY, CURRENCY, FXRATE, ASSET_CODE, "
					"ASSET_DESC, ASSET_CURRENCY, IPO, TRS, REPO_CP, TR_RATE, RATE_BASIS, MATURITY, "
					"NOTE, NOTE2, SW_BOOKING, SW_MATURITY, FLOAT_RATE, FLOAT_RATE_BASIS, FLOAT_MATURITY, "
					"WI, SWAP_TICKET, DELIVERY_DATE, MARGIN, MARGIN_CURRENCY, MARGIN_AMOUNT, FUNDED_SWAP, "
					"BINARY, AA_METHOD, AA_FREASON, BEST_EXECUTION, SHORT_SALE, CSPB_SHORT, ETRADE, PRICE, "
					"DOWN_PYMNT, BROKER_FEE, OTHER_FEE, SOFTDOLLAR, ASSIGN_CP, DV01, VAR, UNWIND_TICKET, "
					"CANCEL_TICKET, CORRECT_TICKET, ASSET_COUNTRY, ASSET_COMMON_CODE, ASSET_MSTC_CODE, "
					"ASSET_ISIN_CODE, ASSET_SEDOL_NUM, ASSET_CLASS, ASSET_IND_AREA, ASSET_CATEGORY, "
					"ASSET_BUCKET, SOURCE, ASSET_COUPON, ASSET_MATURITY, ORDER_ID "
		...
		else
		{
			...
			Sql += "UNION "
					...
					"B.ASS_CURRENCY, NULL \"NEW_ISSUE\", NULL \"TRS\", NULL \"REPO_CP\", TO_CHAR(RATE), "
					"DECODE(A.TRANS_TYPE, 'LEVERAGE', 'A/360', 'REPO', 'A/360', B.ASS_RATE_BASIS), "
					"MATURITY, NULL \"NOTE\", NULL \"NOTE2\", TO_DATE(NULL) \"SW_BOOKING\", "
					"TO_DATE(NULL) \"SW_MATURITY\", TO_NUMBER(NULL) \"FLOAT_RATE\", D.ASS_RATE_BASIS, "
					"A.MATURITY, NULL \"WI\", TO_NUMBER(NULL) \"SWAP_TICKET\", C.DELIVERY_DATE, "
					"TO_NUMBER(NULL) \"MARGIN\", A.CURRENCY, TO_NUMBER(NULL) \"MARGIN_AMOUNT\", NULL \"FUNDED_SWAP\", "
					"NULL \"BINARY\", A.AA_METHOD, NULL \"AA_FREASON\", A.BEST_EXECUTION, NULL \"SHORT_SALE\", "
					"NULL \"CSPB_SHORT\", C.ETRADE, A.PRICE, DECODE(A.DEAL_TYPE, 'TRS', 0, 100) \"DOWN_PYMNT\", "
					"TO_NUMBER(NULL) \"BROKER_FEE\", TO_NUMBER(NULL) \"OTHER_FEE\", TO_NUMBER(NULL) \"SOFTDOLLAR\", "
					"NULL \"ASSIGN_CP\", TO_NUMBER(NULL) \"DV01\", TO_NUMBER(NULL) \"VAR\", "
					"TO_NUMBER(A.REF_TICKET) \"UNWIND_TICKET\", TO_NUMBER(NULL) \"CANCEL_TICKET\", "
					"TO_NUMBER(NULL) \"CORRECT_TICKET\", B.ASS_COUNTRY, B.ASS_COMMON_CODE, B.ASS_MSTC_CODE, "
					"B.ASS_ISIN_CODE, B.ASS_SEDOL_NUM, B.ASS_INDUSTRY, B.ASS_IND_AREA, B.ASS_CATEGORY, "
					"B.BUCKET, B.SOURCE, NULL, B.ASS_MATURITY_DATE, A.ORDER_ID "
					"FROM SEMAM.V_TRADE_ORDER A, SEMAM.NW_ASSETS B, SEMAM.NW_TR_TICKETS C, "
					"SEMAM.NW_ASSETS D, SEMAM.V_OPTION_TICK E "
			...
			Sql += "UNION "
					...
					"B.ASS_CURRENCY, NULL \"NEW_ISSUE\", NULL \"TRS\", NULL \"REPO_CP\", TO_CHAR(RATE), "
					"DECODE(A.TRANS_TYPE, 'LEVERAGE', 'A/360', 'REPO', 'A/360', B.ASS_RATE_BASIS), "
					"MATURITY, NULL \"NOTE\", NULL \"NOTE2\", TO_DATE(NULL) \"SW_BOOKING\", TO_DATE(NULL) \"SW_MATURITY\", "
					"TO_NUMBER(NULL) \"FLOAT_RATE\", D.ASS_RATE_BASIS, A.MATURITY, NULL \"WI\", TO_NUMBER(NULL) \"SWAP_TICKET\", "
					"C.DELIVERY_DATE, TO_NUMBER(NULL) \"MARGIN\", A.CURRENCY, TO_NUMBER(NULL) \"MARGIN_AMOUNT\", "
					"NULL \"FUNDED_SWAP\", NULL \"BINARY\", A.AA_METHOD, NULL \"AA_FREASON\", A.BEST_EXECUTION, "
					"NULL \"SHORT_SALE\", NULL \"CSPB_SHORT\", C.ETRADE, A.PRICE, DECODE(A.DEAL_TYPE, 'TRS', 0, 100) \"DOWN_PYMNT\", "
					"TO_NUMBER(NULL) \"BROKER_FEE\", TO_NUMBER(NULL) \"OTHER_FEE\", TO_NUMBER(NULL) \"SOFTDOLLAR\", "
					"NULL \"ASSIGN_CP\", TO_NUMBER(NULL) \"DV01\", TO_NUMBER(NULL) \"VAR\", TO_NUMBER(A.REF_TICKET) \"UNWIND_TICKET\", "
					...
					"B.ASS_IND_AREA, B.ASS_CATEGORY, B.BUCKET, B.SOURCE, NULL, B.ASS_MATURITY_DATE, A.ORDER_ID "
					"FROM SEMAM.V_TRADE_ORDER A, SEMAM.NW_ASSETS B, SEMAM.NW_TR_TICKETS C, SEMAM.NW_ASSETS D, SEMAM.V_OPTION_TICK E "
					"WHERE B.ASS_CODE(+) = A.ASSET_CODE "
					"AND C.TICKET_NUM(+) = A.REF_TICKET "
					"AND D.ASS_CODE(+) = A.ASSET_CODE2 "
					"AND E.OPT_ASSET_CODE(+) = A.ASSET_CODE||'|'||SUBSTR(A.TRANS_TYPE, 1, 1)||'|'||TO_CHAR(A.STRIKE)||'|'||TO_CHAR(A.OPT_EXP) "
