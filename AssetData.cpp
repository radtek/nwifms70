...
void CAssetData::SetHeaders()
{
	...
	if(GetOraLoader().Open("SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, "
							...
							"ASS_EXCHANGE, ASS_ACCOUNT, UNDERLINE_ID, NOM_AMOUNT, INV_TYPE "
...
int CAssetData::LoadDBData(LPCTSTR TicketNum)
{
	...
	if(TicketNum && strlen(TicketNum) > 0)
	{
		...
		Sql = "SELECT ASSET_CODE, TO_NUMBER(NULL) \"ASSET_NUM\", ASSET_DESC, ASSET_COMMON_CODE, ASSET_MSTC_CODE, "
				...
				"ASS_COUPON_START_DATE, ASS_BEGIN_ROLL_DATE, ASSET_MATURITY, FX_DATE, ASS_FLOAT_INDEX, "
				"ASS_FLOAT_FORMULA, A.SOURCE, ASSET_IND_AREA, ASSET_COUNTRY, ASS_PROFILE_COUNTRY, ASSET_CURRENCY, "
				"ASS_CURRENCY2, ASSET_CLASS, NULL \"ASS_PCLASS2\", ASS_PROFILE_CLASS, ASS_RATE_BASIS, ASS_INT_TYPE, "
				"ASS_FREQ, ASS_CMPD_FREQ, ASSET_CATEGORY, STATUS, ASSET_BUCKET, NULL \"BUCKET2\", NULL \"BUCKET3\", "
				"ASS_ISSUER, DECODE(ASS_CONV_TYPE, 'F', 'FIFO') \"ASS_METHOD\", ASS_SWAP_FACTOR, ASS_INT_RATE, "
				"NULL \"ASS_TYPE\", ASS_ACCRUABLE, ASS_PPAID_INT, UNLISTED_SECURITY, ASS_OTC_CLEAR, ASS_CONV_TYPE, "
				"ASS_1256, ASS_PAR_VALUE, ASS_DF_FEE_TYPE, UNDERLINE_ASSET, BELOW_RATING, ASS_144A, ID_144A, "
				"ASS_ADMIN_ID, ASS_MARGIN, ASS_FRA, ASS_LIQUIDITY, ASS_PF_CLASS, ASS_PF_SUBCLASS, ASS_BDATE, "
				"ASS_CDS_RESTRUCT, ASS_BDC, ASS_CITI_CLASS, BLM_KEY, ASS_YC_NAME, ASS_EXCHANGE, ASS_IRS_TMPLATE, "
				"NULL \"ASS_ACCOUNT\", NULL \"ASSET_ID2\", TO_NUMBER(NULL) \"POSITION\", "
				...
				"ASS_ACCRUABLE, ASS_PPAID_INT, UNLISTED_SECURITY, ASS_OTC_CLEAR, SUBSTR(ASS_CONV_TYPE, 1, 1) \"ASS_CONV_TYPE\", "
				"ASS_1256, ASS_PAR_VALUE, ASS_DF_FEE_TYPE, UNDERLINE_ASSET, BELOW_RATING, ASS_144A, ID_144A, "
				"ASS_ADMIN_ID, ASS_MARGIN, ASS_FRA, ASS_LIQUIDITY, ASS_PF_CLASS, ASS_PF_SUBCLASS, ASS_BDATE, "
				"ASS_CDS_RESTRUCT, ASS_BDC, ASS_CITI_CLASS, BLM_KEY, ASS_YC_NAME, ASS_IRS_TMPLATE, ASS_EXCHANGE, "
				"ASS_ACCOUNT, UNDERLINE_ID, SUM(C.NOM_AMOUNT) \"POSITION\", INV_TYPE "
	...
	else
	{
		...
		Sql = "SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, ASS_SEDOL_NUM, "
				...
				"ASS_MATURITY_DATE, ASS_FX_DATE, ASS_FLOAT_INDEX, ASS_FLOAT_FORMULA, A.SOURCE, ASS_IND_AREA, "
				"ASS_COUNTRY, ASS_PROFILE_COUNTRY, ASS_CURRENCY, ASS_CURRENCY2, ASS_INDUSTRY, ASS_PCLASS2, "
				"ASS_PROFILE_CLASS, ASS_RATE_BASIS, ASS_INT_TYPE, ASS_PAYMENT_FREQUENCY, ASS_CMPD_FREQ, "
				"ASS_CATEGORY, STATUS, BUCKET, BUCKET2, BUCKET3, ASS_ISSUER, ASS_METHOD, ASS_SWAP_FACTOR, "
				"ASS_INT_RATE, ASS_TYPE, ASS_ACCRUABLE, ASS_PPAID_INT, UNLISTED_SECURITY, ASS_OTC_CLEAR, "
				...
				"ASS_YC_NAME, ASS_IRS_TMPLATE, ASS_EXCHANGE, ASS_ACCOUNT, UNDERLINE_ID, SUM(B.NOM_AMOUNT) \"POSITION\", "
				"INV_TYPE "
	...
	Sql += "GROUP BY ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, ASS_SEDOL_NUM, "
			...
			"ASS_IRS_TMPLATE, ASS_EXCHANGE, ASS_ACCOUNT, UNDERLINE_ID, INV_TYPE ";
	Sql += " ORDER BY 1 ";	
