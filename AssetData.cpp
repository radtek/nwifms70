...
void CAssetData::SetHeaders()
{
	...
	if(GetOraLoader().Open("SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, "
							...
							"ASS_PAYMENT_FREQUENCY, ASS_CMPD_FREQ, ASS_INT_RATE, ASS_CATEGORY, STATUS, BUCKET, BUCKET2, "
							"BUCKET3, ASS_ISSUER, ASS_METHOD, ASS_SWAP_FACTOR, ASS_TYPE, ASS_ACCRUABLE, ASS_PPAID_INT, "
							"UNLISTED_SECURITY, ASS_OTC_CLEAR, SUBSTR(ASS_CONV_TYPE, 1, 1) \"ASS_CONV_TYPE\", ASS_1256, "
							"ASS_PAR_VALUE, ASS_DF_FEE_TYPE, UNDERLINE_ASSET, BELOW_RATING, ASS_144A, ID_144A, "
							"ASS_ADMIN_ID, ASS_MARGIN, ASS_FRA, ASS_LIQUIDITY, ASS_PF_CLASS, ASS_PF_SUBCLASS, ASS_BDATE, "
							"ASS_CDS_RESTRUCT, ASS_BDC, ASS_CITI_CLASS, BLM_KEY, ASS_YC_NAME, ASS_IRS_TMPLATE, "
...
int CAssetData::LoadDBData(LPCTSTR TicketNum)
{
	...
	if(TicketNum && strlen(TicketNum) > 0)
	{
		...
		Sql = "SELECT ASSET_CODE, TO_NUMBER(NULL) \"ASSET_NUM\", ASSET_DESC, ASSET_COMMON_CODE, ASSET_MSTC_CODE, "
				...
				"ASS_INT_RATE, ASSET_CATEGORY, STATUS, ASSET_BUCKET, NULL \"BUCKET2\", NULL \"BUCKET3\", ASS_ISSUER, "
				"DECODE(ASS_CONV_TYPE, 'F', 'FIFO') \"ASS_METHOD\", ASS_SWAP_FACTOR, NULL \"ASS_TYPE\", ASS_ACCRUABLE, "
				...
				"ASS_EXCHANGE, ASS_IRS_TMPLATE, NULL \"ASS_ACCOUNT\", NULL \"ASS_FUTURE_TYPE\", NULL \"ASSET_ID2\", "
				...
				"ASS_RATE_BASIS, ASS_INT_TYPE, ASS_PAYMENT_FREQUENCY, ASS_CMPD_FREQ, ASS_INT_RATE, ASS_CATEGORY, STATUS, "
				"BUCKET, BUCKET2, BUCKET3, ASS_ISSUER, ASS_METHOD, ASS_SWAP_FACTOR, ASS_TYPE, ASS_ACCRUABLE, ASS_PPAID_INT, "
	...
	else
	{
		...
		Sql = "SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, ASS_SEDOL_NUM, "
				...
				"ASS_PROFILE_CLASS, ASS_RATE_BASIS, ASS_INT_TYPE, ASS_PAYMENT_FREQUENCY, ASS_CMPD_FREQ, ASS_INT_RATE, "
				"ASS_CATEGORY, STATUS, BUCKET, BUCKET2, BUCKET3, ASS_ISSUER, ASS_METHOD, ASS_SWAP_FACTOR, ASS_TYPE, "
...
BOOL CAssetData::ImportImagineAsset()
{
	...
	if(GetOraLoader().Open("SELECT NULL \"ASS_CODE\", TO_NUMBER(NULL) \"ASSET_NUM\", ASS_DESC, NULL \"ASS_COMMON_CODE\", "
						...
						"ASS_FREQ, ASS_CMPD_FREQ, ASS_INT_RATE, ASS_CATEGORY, STATUS, BUCKET, NULL \"BUCKET2\", NULL \"BUCKET3\", "
