...
int CTicketApprovalData::LoadTickets()
{
	...
	{
		if(IsTrader())
			Sql = "SELECT DISTINCT A.SIGN, A.TRADER_INI, A.TICKET_NUM, A.TRADE_DATE, A.EXEC_TIME, "
					"TO_CHAR(A.BOOK_DATE, 'MM/DD/YY HH24:MI:SS') \"DATE_STAMP\", A.VALUE_DATE, A.DIR, A.TRANS_TYPE, "
					"A.TOTAL_NOM_AMOUNT, A.STRIKE, A.OPT_EXPIRATION, A.OTC, A.OPT_TICK, A.OPT_SET_CODE, A.OPT_SET_CODE2, "
					...
					"FROM SEMAM.RAW_TICKET_V A, SEMAM.NW_BUCKETS B, SEMAM.NW_TRADERS C, SEMAM.NW_EMCFPERFISO_EQ_ALLOC_V E "
					...
					"UNION "
					"SELECT DISTINCT A.SIGN, A.TRADER_INI, A.TICKET_NUM, TRADE_DATE, A.EXEC_TIME, "
					"TO_CHAR(A.BOOK_DATE, 'MM/DD/YY HH24:MI:SS') \"DATE_STAMP\", A.VALUE_DATE, A.DIR, A.TRANS_TYPE, "
					"A.TOTAL_NOM_AMOUNT, A.STRIKE, A.OPT_EXPIRATION, A.OTC, A.OPT_TICK, A.OPT_SET_CODE, A.OPT_SET_CODE2, "
					"A.ASSET_PID, A.EURO_OPT, A.OPT_AUTO, A.CURRENCY, A.FXRATE, A.COUNTERPARTY, A.ASSET_CODE, A.ASSET_DESC, "
					"A.ASSET_CURRENCY, A.ASSET_COUNTRY, A.ASSET_COMMON_CODE, A.ASSET_MSTC_CODE, A.ASSET_ISIN_CODE, "
			...
			Sql = "SELECT DISTINCT A.SIGN, A.TRADER_INI, TO_CHAR(A.TICKET_NUM) \"TICKET_NUM\", A.TRADE_DATE, A.EXEC_TIME, "
					"TO_CHAR(A.BOOK_DATE, 'MM/DD/YY HH24:MI:SS') \"DATE_STAMP\", A.VALUE_DATE, A.DIR, A.TRANS_TYPE, "
					"A.TOTAL_NOM_AMOUNT, A.STRIKE, A.OPT_EXPIRATION, A.OTC, A.OPT_TICK, A.OPT_SET_CODE, A.OPT_SET_CODE2, "
					"A.ASSET_PID, A.EURO_OPT, A.OPT_AUTO, A.CURRENCY, A.FXRATE, A.COUNTERPARTY, A.ASSET_CODE, A.ASSET_DESC, "
					"A.ASSET_CURRENCY, A.ASSET_COUNTRY, A.ASSET_COMMON_CODE, A.ASSET_MSTC_CODE, A.ASSET_ISIN_CODE, "
					...
					"FROM SEMAM.RAW_TICKET_V A, SEMAM.NW_BUCKETS B, SEMAM.NW_EMCFPERFISO_EQ_ALLOC_V E "
					"WHERE B.BUCKET(+) = A.ASSET_BUCKET "
					"AND E.ASSET_CODE(+) = A.ASSET_CODE "
					"AND TRUNC(A.BOOK_DATE) = TRUNC(SYSDATE) "
					"UNION "
		...
		if(GetSign())
			Sql = "SELECT DISTINCT A.TRADER_SIGN, A.TRADER_INI, A.TICKET_NUM, A.TRADE_DATE, A.EXEC_TIME, "
					"TO_CHAR(A.BOOK_DATE, 'MM/DD/YY HH24:MI:SS') \"DATE_STAMP\", A.VALUE_DATE, A.DIR, A.TRANS_TYPE, "
					"A.TOTAL_NOM_AMOUNT, A.STRIKE, A.OPT_EXPIRATION, A.OTC, A.OPT_TICK, A.OPT_SET_CODE, A.OPT_SET_CODE2, "
					"A.ASSET_PID, A.EURO_OPT, A.OPT_AUTO, A.CURRENCY, A.FXRATE, A.COUNTERPARTY, A.ASSET_CODE, A.ASSET_DESC, "
					"A.ASSET_CURRENCY, A.ASSET_COUNTRY, A.ASSET_COMMON_CODE, A.ASSET_MSTC_CODE, A.ASSET_ISIN_CODE, "
