...
{
	GetOraLoader().GetSql() = "SELECT TRANS_NUM, PORTFOLIO, TICKET_NUM, COUNTERPARTY, "
					"ASSET_CODE, TRADER_INI, TRADE_DATE, VALUE_DATE, TRANS_TYPE, "
					"TRANS_DIRECTION, NOM_AMOUNT, PRICE, CURRENCY, FXRATE, CON_CODE, "
					"DEAL_TYPE, EXERCISE_PRICE, EXERCISE_DATE, OPT_EXPIRATION, FX_DATE, "
					"OPT_TICK, OPT_SET_CODE, OPT_SET_CODE2, SET_CONVENTION, OPT_ID, "
					"EURO_OPT, OPT_AUTO, BR_FEES, A.SOFTDOLLAR, LEV_RATE, VAR, TR_RATE, "
					...
					"HAN_DETAIL2, CP_TRADE_ID, DOC_REQ, DOC_RECVD, WI, CONFIRM, SWAP_TICKET, "
					"DELIVERY_DATE, MARGIN, MARGIN_CURRENCY, MARGIN_AMOUNT, LISTED, "
					"FUNDED_SWAP, BINARY, DV01, BEST_EXECUTION, SHORT_SALE, A.CSPB_SHORT, "
					"CANCEL_TICKET, CORRECT_TICKET, SEC_FEE, OR_FEE, ETRADE, BOOKER, BOOK_DATE, "
					"TR_VERSION, ASS_DESC, ASS_CURRENCY, ASS_INDUSTRY "
					"FROM SEMAM.NW_TR_TICKETS A, SEMAM.NW_ASSETS B "
					"WHERE B.ASS_CODE(+) = A.ASSET_CODE ";
	...
	GetOraLoader().GetSql() = "SELECT INV_NUM, ASSET_CODE, TR_DESC, NOM_AMOUNT, "
							"ACTUAL_VDATE, ACTUAL_CLOSING, POST_DATE, CURRENCY, "
							"FOREX_REF_NUM, CROSS_RATE, CASH_AMOUNT, INT_AMOUNT, "
							"ACC_CODE, ASSIGN_CP, ASSIGN_CT FROM SEMAM.NW_TR_INV "
							"WHERE TRANS_NUM = 1 ";
	GetOraLoader().Open();
