...
int CConfirmData::LoadTickets()
{
	...
	if(GetSS()->GetFieldArray().GetSize() <= 0)
	{
		GetOraLoader().GetSql() = "SELECT COUNTERPARTY, TICKET_NUM, PORTFOLIO, TRANS_NUM, TRADE_DATE, ASSET_CODE, "
									...
									"A.CURRENCY, FXRATE, CON_CODE, DEAL_TYPE, EXERCISE_PRICE, EXERCISE_DATE, "
									...
									"AND C.CURRENCY(+) = A.ASS_CURRENCY2 "
									"AND 1 = 2";
	...
	GetOraLoader().GetSql() = "SELECT TRANS_NUM, COUNTERPARTY, TICKET_NUM, PORTFOLIO, TRANS_NUM, TRADE_DATE, ASSET_CODE, "
								"TRADER_INI, VALUE_DATE, TRANS_TYPE, TRANS_DIRECTION, NOM_AMOUNT, PRICE, A.CURRENCY, "
								"FXRATE, CON_CODE, DEAL_TYPE, EXERCISE_PRICE, EXERCISE_DATE, OPT_EXPIRATION, FX_DATE, "
								"OPT_TICK, OPT_SET_CODE, OPT_SET_CODE2, SET_CONVENTION, OPT_ID, EURO_OPT, OPT_AUTO, "
								"BR_FEES, A.SOFTDOLLAR, LEV_RATE, VAR, TR_RATE, RATE_BASIS, MATURITY_DATE, FLOAT_RATE_INDEX, "
...
void CConfirmData::SetHeaders()
{
	GetOraLoader().GetSql() = "SELECT COUNTERPARTY, TICKET_NUM, PORTFOLIO, TRANS_NUM, TRADE_DATE, ASSET_CODE, TRADER_INI, "
								"VALUE_DATE, TRANS_TYPE, TRANS_DIRECTION, NOM_AMOUNT, PRICE, A.CURRENCY, FXRATE, CON_CODE, "
