...
int CCashData::LoadDBData()
{
	...
	{
		GetOraLoader().GetSql() = "SELECT CASH_NUM, PORTFOLIO, ACC_CODE, PMNT_TYPE, CURRENCY, ASS_CODE, "
									"CLOSE_DATE, POST_DATE, TO_DATE, AMOUNT, FXRATE, REMAINING, "
									"DIFF_REASON, COMMENTS, PAY_ID, CUST_REFERENCE, ACC_TO, TO_PORTFOLIO, "
									"LINK, SWAP_TRANS_NUM, COUPON_PAID, BOOK_DATE, "
