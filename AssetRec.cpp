...
void CAssetRec::Copy(CAssetRec &Rec)
{
	...
	SetFutureType(Rec.GetFutureType());
}
...
BOOL CAssetRec::AddRec(COraLoader &OraLoader)
{
	...
	if(!OraLoader.Open("SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, "
						...
						"UNLISTED_SECURITY, ASS_OTC_CLEAR, ASS_CONV_TYPE, ASS_1256, ASS_PAR_VALUE, ASS_DF_FEE_TYPE, "
						"UNDERLINE_ASSET, BELOW_RATING, ASS_144A, ID_144A, ASS_ADMIN_ID, ASS_MARGIN, ASS_FRA, "
						"ASS_LIQUIDITY, ASS_PF_CLASS, ASS_PF_SUBCLASS, ASS_BDATE, ASS_CDS_RESTRUCT, ASS_BDC, "
						"ASS_CITI_CLASS, BLM_KEY, ASS_YC_NAME, ASS_IRS_TMPLATE, ASS_EXCHANGE, ASS_ACCOUNT, ASS_FUTURE_TYPE "
...
BOOL CAssetRec::UpdateRec(COraLoader &OraLoader, BOOL bByID)
{
	...
	Sql = ("SELECT ASS_CODE, ASSET_NUM, ASS_DESC, ASS_COMMON_CODE, ASS_MSTC_CODE, ASS_ISIN_CODE, ASS_SEDOL_NUM, "
			...
			"BUCKET, BUCKET2, BUCKET3, ASS_ISSUER, ASS_METHOD, ASS_SWAP_FACTOR, ASS_TYPE, ASS_ACCRUABLE, "
			...
			"ASS_IRS_TMPLATE, ASS_EXCHANGE, ASS_ACCOUNT, ASS_FUTURE_TYPE FROM SEMAM.NW_ASSETS "
			"WHERE ASS_CODE = %s ");
